          ...
          <Row className="justify-content-center">
            <div className="section-title text-center">
              <h3 className="title mb-4 pb-2">
                {language === 'pt' ? "Veja tudo sobre seu funcionário em um só lugar." : "See everything about your employee in one place."}
              </h3>
              <p className="para-desc text-muted mx-auto">
                {language === 'pt' ? "Comece a trabalhar com a Recruitment, que pode fornecer tudo o que você precisa para gerar reconhecimento, atrair tráfego e conectar." :
