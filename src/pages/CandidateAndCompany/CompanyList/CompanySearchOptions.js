...
import IndustryType from "../../Home/SubSection/IndustryType";
          ...
          <Col lg={3} md={6}>
            <div className="filler-job-form">
              ...
              <Input
                ...
                placeholder={language === 'pt' ? "Nome, descrição, etc..." : "Name, description, etc..."}
...
export default CompanySearchOptions;